...
---
This page contains an illustrative example on how to fit the **Damped Linear Oscillator model** to a single individual's negative affect measures. Note that this example was conceived as a supplementary material to (reference). Please access (link) for more details. 
...
The data used in this tutorial is available for download [here]("DLO_Tutorial_Individual.txt"). Now, to load the data and see the first lines of it: 
```{r}
